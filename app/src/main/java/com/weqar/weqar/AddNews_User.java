...
public class AddNews_User extends AppCompatActivity {
...
//TextView et_addevent_uploaddoc;
private int PICK_PDF_REQUEST = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isConnectedToNetwork()) {
           ...
           // et_addevent_uploaddoc = findViewById(R.id.et_addevent_uploaddoc);
            ...
            iv_addnews_back.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    startActivity(new Intent(AddNews_User.this, News_Display.class));
                }
            });
...
//            et_addevent_uploaddoc.setOnClickListener(new View.OnClickListener() {
//                @Override
//                public void onClick(View v) {
//                    showFileChoosers();
//                }
//            });
        ...
        else
        {
            ...
            but_retry.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(AddNews_User.this, AddNews_User.class);
    ...
    private void getStudents(JSONArray j) {
        ...
        sp_addnews_newstype.setAdapter(new ArrayAdapter<String>(AddNews_User.this, android.R.layout.simple_dropdown_item_1line, vendor_plan));
    }
...
//            String  PdfPathHolder = FilePath.getPath(AddNews_User.this, filePath);
...
//            upload_vendor_complete_image_s(bitmap);
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, Global_URL.User_uploadprofessionalimage, new Response.Listener<String>() {
                public void onResponse(String response) {
                    try
                    {
                        ...
                        String s_addnews_image=jObj.getString("Response");
                        Toast.makeText(AddNews_User.this, s_addnews_image, Toast.LENGTH_SHORT).show();
    ...
    public void callmetoupload_news()
    {
        ...
        {
            new PromptDialog(AddNews_User.this)
