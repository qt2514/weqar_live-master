...
public class NewsDetails_Guest extends AppCompatActivity {
    ImageView IV_news_det_back,IV_news_det_image;
    TextView TV_news_det_title,TV_news_det_type,TV_nes_det_desc,news_det_u_url;
...
//                but_news_det_follow = findViewById(R.id.but_news_det_follow);
//                but_news_det_follow.setOnClickListener(new View.OnClickListener() {
//                    @Override
//                    public void onClick(View v) {
//                        new PromptDialog(NewsDetails_Guest.this)
//                                .setDialogType(PromptDialog.DIALOG_TYPE_WRONG)
//                                .setAnimationEnable(true)
//                                .setTitleText("Please Sign In")
//                                .setContentText("You need to Signin/Signup to follow the News")
//                                .setPositiveListener(("ok"), new PromptDialog.OnPositiveListener() {
//                                    @Override
//                                    public void onClick(PromptDialog dialog) {
//                                        startActivity(new Intent(NewsDetails_Guest.this, LoginActivity.class));
//                                    }
//                                }).show();
//                    }
//                });
                ...
                news_det_u_url.setText(s_news_url);
            ...
            IV_news_det_back.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(NewsDetails_Guest.this, NewsDisplay_Guest.class));
                }
            });
        }
        else
        {
            ...
            but_retry.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(NewsDetails_Guest.this, NewsDisplay_Guest.class);
