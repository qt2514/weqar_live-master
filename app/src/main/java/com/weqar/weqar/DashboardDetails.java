    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isConnectedToNetwork()) {
            ...
            try {
                ...
                RV_discdet_user = findViewById(R.id.discount_rv_user);
            ...
            dashboard_back_user.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(DashboardDetails.this, HomeScreen.class));
                }
            });
        }else
        {
            ...
            but_retry.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(DashboardDetails.this, DashboardDetails.class);
                    startActivity(intent);
                }
            });
        }
...
//
//                            TV_d_eventdet_startdate.setText("Start Date : "+s_d_event_startdate);
//                            TV_d_eventdet_enddate.setText("End Date : "+s_d_event_enddate);
                            ...
                            //TV_d_eventdet_desc.setText(s_d_event_desc);

                            Picasso.with(DashboardDetails.this).load(Global_URL.Image_url_load + s_d_event_image).error(getResources().getDrawable(R.drawable.rounded_two)).fit().centerCrop().into(IV_d_eventdet_image);
                        }
                        else
                        {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        //news_det_u_desc.setText(s_d_content);
                        ...
                        Picasso.with(DashboardDetails.this).load(Global_URL.Image_url_load + s_d_image).error(getResources().getDrawable(R.drawable.rounded_two)).fit().centerCrop().into(news_udet_image);
                    }
