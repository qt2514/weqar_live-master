...
import com.weqar.weqar.JavaClasses.RecyclerViewAdapter_DashboardDetails_Vendor;
...
public class DashboardDetails_Vendor extends AppCompatActivity {
    ...
    TextView TV_toolbar_title,
            //TV_d_discdet_title,TV_d_discdet_enddate,TV_d_discdet_desc,
            TV_d_eventdet_title,TV_d_eventdet_startdate,TV_d_eventdet_enddate,TV_d_eventdet_place,TV_d_eventdet_desc,
    ...
    String s_d_disc_user_id,s_d_disc_id,s_d_disc_image,s_d_disc_perc,s_d_disc_title,s_d_disc_enddate,s_d_disc_desc,
            s_d_event_user_id,s_d_event_id,s_d_event_image,s_d_event_title,s_d_event_startdate,s_d_event_place,s_d_event_desc,
            s_d_event_name,s_d_event_amount,s_d_event_lati,s_d_event_longi,s_d_event_ispaid,s_d_event_regreq,s_d_event_prereq,

    s_d_news_userid,s_d_newsid,s_d_image,s_d_url,s_d_attachment,s_d_title,s_d_content,s_d_newtype,typess;

    //  CircleImageView CV_d_discdet_logo;

    ImageView dashboard_back_user,IV_d_eventdet_image,news_udet_image;
//    IV_d_discdet_image,
  //  RatingBar RB_d_discdet_rating;
    ...
    RecyclerViewAdapter_DashboardDetails_Vendor RecyclerViewHorizontalAdapter;
    LinearLayoutManager HorizontalLayout ;
    Button dashboard_event_location_locate,dashboard_det_event_follow;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dashboard_details__vendor);
...
//            TV_d_discdet_title=findViewById(R.id.TV_d_discdet_title);
//            TV_d_discdet_enddate=findViewById(R.id.TV_d_discdet_enddate);
//            TV_d_discdet_desc=findViewById(R.id.TV_d_discdet_desc);
//            CV_d_discdet_logo=findViewById(R.id.CV_d_discdet_logo);
//            IV_d_discdet_image=findViewById(R.id.IV_d_discdet_image);
//            RB_d_discdet_rating=findViewById(R.id.RB_d_discdet_rating);
            RV_discdet_user = findViewById(R.id.discount_rv_vendor);
            ...
            RecyclerViewHorizontalAdapter = new RecyclerViewAdapter_DashboardDetails_Vendor(L_disc_det_id, L_disc_det_desc, L_disc_det_image,
            ...
            TV_toolbar_title.setText(S_dashboard_type);
           // Picasso.with(this).load(Global_URL.Image_url_load + S_dashboard_logo).error(getResources().getDrawable(R.drawable.rounded_two)).fit().centerCrop().into(CV_d_discdet_logo);
        ...
        }catch(Exception e)
        {
            ...
            @Override
            public void onClick(View v) {
                startActivity(new Intent(DashboardDetails_Vendor.this,HomeScreen_vendor.class));
            }
        });
        }
        else
        {
            ...
            but_retry.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(DashboardDetails_Vendor.this, DashboardDetails_Vendor.class);
                    startActivity(intent);
                }
            });
        }
                ...
                public void onResponse(String response) {
                    try {
                        ...
                        if(status.equals("Success"))
                        {
                            ...
                            if(s_vendor_disc.equals(s_d_event_user_id))
                            {
                            ...
                            Picasso.with(DashboardDetails_Vendor.this).load(Global_URL.Image_url_load + s_d_event_image).error(getResources().getDrawable(R.drawable.rounded_two)).fit().centerCrop().into(IV_d_eventdet_image);
                        }
                        else
                        {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        Picasso.with(DashboardDetails_Vendor.this).load(Global_URL.Image_url_load + s_d_image).error(getResources().getDrawable(R.drawable.rounded_two)).fit().centerCrop().into(news_udet_image
