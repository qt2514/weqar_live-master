...
public class RecyclerViewAdapter_DashboardDetails_Guest extends RecyclerView.Adapter<RecyclerViewAdapter_DashboardDetails_Guest.MyView>{
    Context context;
    ...
    public RecyclerViewAdapter_DashboardDetails_Guest(List<String> horizontalList_id,
