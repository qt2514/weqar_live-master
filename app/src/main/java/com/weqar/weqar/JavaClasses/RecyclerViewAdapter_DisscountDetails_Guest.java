...
public class RecyclerViewAdapter_DisscountDetails_Guest extends RecyclerView.Adapter<RecyclerViewAdapter_DisscountDetails_Guest.MyView>{
    Context context;
     ...
     //   RatingBar RB_rating_userisc;
        ...
        public MyView(View view) {
          ...
          //  RB_rating_userisc = view.findViewById(R.id.disc_desc_rating);
            ...
            disc_det_apply=view.findViewById(R.id.disc_det_apply);
            disc_det_follow=view.findViewById(R.id.disc_det_follow);
    ...
    public RecyclerViewAdapter_DisscountDetails_Guest(List<String> horizontalList_id,
    ...
    public void onBindViewHolder(final MyView holder, final int position) {
        ...
        Spanned htmlAsSpanned = Html.fromHtml(u_list_desc.get(position));
...
holder.disc_det_apply.setOnClickListener(new View.OnClickListener() {
    @Override
    public void onClick(View v) {
        ...
        new PromptDialog(context)
                ...
                .setContentText("You need to Signin/Signup to apply a Discount")
        ...
        holder.disc_det_follow.setOnClickListener(new View.OnClickListener() {
    @Override
    public void onClick(View v) {
