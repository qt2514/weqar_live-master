...
public class RecyclerViewAdapter_DashboardDetails_Vendor  extends RecyclerView.Adapter<RecyclerViewAdapter_DashboardDetails_Vendor.MyView>{
    Context context;
    ...
    public RecyclerViewAdapter_DashboardDetails_Vendor(List<String> horizontalList_id,
