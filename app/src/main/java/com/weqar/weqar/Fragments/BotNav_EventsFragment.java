...
import com.weqar.weqar.DashboardDetails;
...
public class BotNav_EventsFragment extends Fragment {
   ...
   ImageView IV_event;
    ...
    RelativeLayout relative_events_show;
    ...
    //  relative_events_show=view.findViewById(R.id.relative_events_show);
...
//        relative_events_show.setVisibility(View.VISIBLE);
//    }
//});
//        relative_events_show.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                dash_menu.close(true);
//                relative_events_show.setVisibility(View.GONE);
//
//
//            }
//        });
       //  dash_menu = new FloatingActionMenu(getActivity());
...
//                    holder.TV_event_end.setText("End Date : "+dash_eventisc_end+" "+time_sched_end);
                    ...
                    holder.TV_event_edesc.setText(htmlAsSpanneds);                    try {
                        Picasso.with(context).load(Global_URL.Image_url_load + ccitacc.getImage()).error(getResources().getDrawable(R.drawable.rounded_two)).fit().centerCrop().into(holder.image_event_user);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
