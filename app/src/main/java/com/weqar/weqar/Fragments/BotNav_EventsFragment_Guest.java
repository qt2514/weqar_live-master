...
import com.weqar.weqar.DashboardDetails_Guest;
import com.weqar.weqar.EventsDisplay_Guest;
import com.weqar.weqar.Events_Display;
import com.weqar.weqar.Global_url_weqar.Global_URL;
import com.weqar.weqar.NewsDisplay_Guest;
...
public class BotNav_EventsFragment_Guest extends Fragment {
    ...
    public static BotNav_EventsFragment_Guest newInstance() {
        BotNav_EventsFragment_Guest fragment= new BotNav_EventsFragment_Guest();
        return fragment;
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_bot_nav__events_fragment__guest, container, false);
...
//        s_vendor_token = Shared_user_details.getString("weqar_token", null);
        ...
        But_dash_u_events.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getActivity(),EventsDisplay_Guest.class));
            }
        });
        ...
        But_dash_u_news.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getActivity(),NewsDisplay_Guest.class));
            }
        });
...
//        LV_listview.addHeaderView(headerview);
        ...
        LV_listview.setOnScrollListener(new EndlessScrollListener() {
            @Override
...
//                    holder.TV_event_edesc.setText(ccitacc.getDescription());
    ...
    public class kilomilo extends AsyncTask<String, String, List<dashboard_list>> {
        ...
        protected List<dashboard_list> doInBackground(String... params) {
            ...
            try {
                ...
                connection.setRequestProperty("x-api-key","OSXQhyFjrr+7D7/f7d7Y8r7OG/kqRgALlwPDohoHIVG6+Qhfe2FV5P3Vf1mwtxu0O8a55HMZNO735u61hODO+g==");
               ...
               MovieAdap adapter = new MovieAdap(getActivity(), R.layout.conent_dashboard_user, movieMode);
                ...
                LV_listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Intent intent = new Intent(getActivity(),DashboardDetails_Guest.class);
