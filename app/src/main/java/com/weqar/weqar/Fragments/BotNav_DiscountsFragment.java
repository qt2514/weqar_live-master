...
public class BotNav_DiscountsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      public class MovieAdap extends ArrayAdapter {
        ...
        Context context;
        private LayoutInflater inflater = (LayoutInflater) getActivity().getSystemService(LAYOUT_INFLATER_SERVICE);
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder.textone =  convertView.findViewById(R.id.TV_disc_percentage);
                holder.TV_enddate =  convertView.findViewById(R.id.text_enddate);
                holder.TVstartdate =  convertView.findViewById(R.id.text_startdate);
...
else
{
    ...
    @SuppressLint("StaticFieldLeak")
    public class newkilomilo extends AsyncTask<String, String, List<discountcard_list>> {
        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            dialog.show();
