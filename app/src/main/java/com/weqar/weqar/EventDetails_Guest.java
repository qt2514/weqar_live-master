...
public class EventDetails_Guest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_event_details__guest);
        ...
        if (isConnectedToNetwork()) {
            ...
            events_det_register.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    new PromptDialog(EventDetails_Guest.this)
                            .setDialogType(PromptDialog.DIALOG_TYPE_WRONG)
                            .setAnimationEnable(true)
                            .setTitleText("Please Sign In")
                            .setContentText("You need to Signin/Signup to follow an Event")
                            .setPositiveListener(("ok"), new PromptDialog.OnPositiveListener() {
                                @Override
                                public void onClick(PromptDialog dialog) {
                                    startActivity(new Intent(EventDetails_Guest.this, LoginActivity.class));
                                }
                            }).show();
                }
            });
            ...
            event_vdet_back.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(EventDetails_Guest.this, EventsDisplay_Guest.class));
            ...
            try {
                ...
                TV_title.setText(event_title);
                Picasso.with(EventDetails_Guest.this).load(Global_URL.Image_url_load + event_image).error(getResources().getDrawable(R.drawable.rounded_two)).fit().centerCrop().into(event_vdet_image);
        ...
        } else
        {
            ...
            but_retry.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(EventDetails_Guest.this, EventsDisplay_Guest.class);
                    startActivity(intent);
                }
            });
        }
