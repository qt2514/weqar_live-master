...
import com.weqar.weqar.JavaClasses.RecyclerViewAdapter_DisscountDetails_Guest;
...
public class DiscountDetails_Guest extends AppCompatActivity {
    ImageView IV_discount_details_back;
    RecyclerView RV_discdet_user;
    RecyclerView.LayoutManager RecyclerViewLayoutManager;
    RecyclerViewAdapter_DisscountDetails_Guest RecyclerViewHorizontalAdapter;
    ...
    String s_disc_det_startdate,s_disc_det_id,s_disc_det_desc,s_disc_det_image,s_disc_edt_percentage,s_disc_det_title,s_disc_det_type,s_det_det_logo,s_disc_det_enddate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_discount_details__guest);
        ...
        if (isConnectedToNetwork()) {
            ...
            RecyclerViewHorizontalAdapter = new RecyclerViewAdapter_DisscountDetails_Guest(L_disc_det_id, L_disc_det_desc, L_disc_det_image,
        ...
        else
        {
            ...
            but_retry.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(DiscountDetails_Guest.this, HomeScreen_Guest.class);
