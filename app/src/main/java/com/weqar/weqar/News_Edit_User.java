...
public class News_Edit_User extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isConnectedToNetwork()) {
            ...
            try {
                ...
                news_edit_userid = intent.getStringExtra("putu_userid_fornews_edit");
                news_edit_newsid = intent.getStringExtra("putu_newsid_fornews_edit");
                news_edit_newsurl = intent.getStringExtra("putu_url_fornews_edit");
                news_edit_title = intent.getStringExtra("putu_title_fornews_edit");
                news_edit_typeid = intent.getStringExtra("putu_type_fornews_edit");
                news_edit_image = intent.getStringExtra("putu_image_fornews_edit");
                news_edit_content = intent.getStringExtra("putu_content_fornews_edit");
            ...
            iv_editnews_back.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    startActivity(new Intent(News_Edit_User.this, News_Display.class));
                }
            });
        ...
        } else
        {
            ...
            but_retry.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(News_Edit_User.this, News_Display.class);
    ...
    private void getStudents(JSONArray j) {
        ...
        sp_editnews_newstype.setAdapter(new ArrayAdapter<String>(News_Edit_User.this, android.R.layout.simple_dropdown_item_1line, vendor_plan));
    }
    ...
    public void callme_toupdate_news_vendor()
    {
        ...
        {
            new PromptDialog(News_Edit_User.this)
                ...
                public void onResponse(String response) {
                    ...
                    new PromptDialog(News_Edit_User.this)
                            ...
                            .setPositiveListener(("ok"), new PromptDialog.OnPositiveListener() {
                                @Override
                                public void onClick(PromptDialog dialog) {
                                    startActivity(new Intent(News_Edit_User.this,News_Display_Vendor
                                            .class));
                                }
                            }).show();
                }
